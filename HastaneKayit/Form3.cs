...
namespace HastaneKayit
{
    public partial class Form3 : Form
    {
        ...
        private void HastaBilgiGetir()
        {
            ...
            baglantim.Open();
            OleDbCommand kom = new OleDbCommand("Select * from hastabilgi where Doktor='" +"Prof.Dr Ahmet"+ "' and RandevuTarih='" + label2.Text + "' ", baglantim);
        ...
        {
            baglantim.Open();
            OleDbCommand kom = new OleDbCommand("Select * from hastabilgi where RandevuSaat='" + label1.Text + "' and RandevuTarih='" + dateTimePicker1.Text + "' and  Doktor='"+ "Prof.Dr Ahmet" + "'  ", baglantim);
            OleDbDataReader oku = kom.ExecuteReader();
